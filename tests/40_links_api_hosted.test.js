...
/**
 * Tests for Links API - Hosted Mode (Umami v3.x)
...
describe("Links API (Umami v3.x) - Hosted Mode - READ-ONLY", function () {
    let client = null;
    let testLinkId = null;
    ...
    before(async function () {
        ...
        if (verbose) {
            console.info(`Test against Umami Hosted (${testEnv.hostedServer}) - Links API`);
        }
